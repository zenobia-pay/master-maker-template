/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: fddbe1523812d893b01e85876a4d722e)
// Runtime types generated with workerd@1.20251004.0 2025-07-12 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "UserShard";
	}
	interface Env {
		KV: KVNamespace;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "OPENAI_API_KEY" | "BASE_URL" | "BETTER_AUTH_SECRET" | "WEB_APP_URL">> {}
}
declare module "*.sql" {
	const value: string;
